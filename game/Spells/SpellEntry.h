...
namespace Spells
{
    ...
    inline bool IsSingleFromSpellSpecificPerTargetPerCaster(SpellSpecific spellSpec1, SpellSpecific spellSpec2)
    {
        switch (spellSpec1)
        {
            case SPELL_SEAL: // WALLCRAFT ALPHA PALADIN CHANGE
            case SPELL_BLESSING:
            case SPELL_AURA:
            case SPELL_STING:
            case SPELL_CURSE:
    ...
    inline bool IsSingleFromSpellSpecificSpellRanksPerTarget(SpellSpecific spellSpec1, SpellSpecific spellSpec2)
    {
        switch (spellSpec1)
        {
            ...
            case SPELL_CURSE:
            case SPELL_ASPECT:
     //     case SPELL_JUDGEMENT: -- WALLCRAFT ALPHA PALADIN CHANGE
                return spellSpec1 == spellSpec2;
            default:
                return false;
        }
...
class SpellEntry
{
    ...
    public:
        ...
        inline bool IsSealSpell() const
        {
            ...
            return IsFitToFamily<SPELLFAMILY_PALADIN,/* CF_PALADIN_SEAL_OF_THE_CRUSADER, CF_PALADIN_SEAL_OF_COMMAND --Wallcraft change */ CF_PALADIN_SEALS>();
        }

		//Wallcraft Real Auras™
		inline bool IsPaladinAura() const
		{
			//Collection of all the paladin aura family flags.
			return IsFitToFamily<SPELLFAMILY_PALADIN, CF_PALADIN_AURAS>();
		}
