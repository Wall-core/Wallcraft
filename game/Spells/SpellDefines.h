...
{   // (C) used in caster aura state     (T) used in target aura state
    ...
    // Custom aura states - not based on spell data:  Wallcraft changes below
    AURA_STATE_HEALTHLESS_15_PERCENT        = 9,
    AURA_STATE_HEALTHLESS_10_PERCENT        = 10,
    AURA_STATE_HEALTHLESS_5_PERCENT         = 11,
    AURA_STATE_POWERLESS_20_PERCENT         = 12,
    AURA_STATE_HEALTHLESS_35_PERCENT        = 13,
    AURA_STATE_HEALTHLESS_100_PERCENT       = 14,
	AURA_STATE_POWERLESS_100_PERCENT		= 15,
	AURA_STATE_DEVOTED						= 16,
	AURA_STATE_NOT_FALLING					= 17,
	AURA_STATE_NOT_MOVING					= 18,
	AURA_STATE_BAD_MOON						= 19,
	AURA_STATE_DEEP_ROOTS					= 20,
	AURA_STATE_RIGHTEOUS					= 21,
};
...
enum SpellAttributes
{
    ...
    SPELL_ATTR_WEARER_CASTS_PROC_TRIGGER      = 0x00000800,            // 11 Wearer casts proc trigger
