...
--
-- Dumping data for table `spellcasttimes`
--

LOCK TABLES `spellcasttimes` WRITE;
/*!40000 ALTER TABLE `spellcasttimes` DISABLE KEYS */;
/*!40000 ALTER TABLE `spellcasttimes` ENABLE KEYS */;
UNLOCK TABLES;
