...
--
-- Dumping data for table `creaturedisplayinfo`
--

LOCK TABLES `creaturedisplayinfo` WRITE;
/*!40000 ALTER TABLE `creaturedisplayinfo` DISABLE KEYS */;
/*!40000 ALTER TABLE `creaturedisplayinfo` ENABLE KEYS */;
UNLOCK TABLES;
