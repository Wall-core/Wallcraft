...
CREATE TABLE `creaturedisplayinfoextra` (
  ...
  `BakedTextureIDblp` text,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPRESSED KEY_BLOCK_SIZE=8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `creaturedisplayinfoextra`
--

LOCK TABLES `creaturedisplayinfoextra` WRITE;
/*!40000 ALTER TABLE `creaturedisplayinfoextra` DISABLE KEYS */;
/*!40000 ALTER TABLE `creaturedisplayinfoextra` ENABLE KEYS */;
UNLOCK TABLES;
