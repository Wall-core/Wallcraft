...
--
-- Dumping data for table `soundentries`
--

LOCK TABLES `soundentries` WRITE;
/*!40000 ALTER TABLE `soundentries` DISABLE KEYS */;
/*!40000 ALTER TABLE `soundentries` ENABLE KEYS */;
UNLOCK TABLES;
