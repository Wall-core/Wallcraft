...
--
-- Dumping data for table `spelldifficulty`
--

LOCK TABLES `spelldifficulty` WRITE;
/*!40000 ALTER TABLE `spelldifficulty` DISABLE KEYS */;
/*!40000 ALTER TABLE `spelldifficulty` ENABLE KEYS */;
UNLOCK TABLES;
