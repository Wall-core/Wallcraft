...
CREATE TABLE `spellvisualprecasttransitions` (
  ...
  `PrecastLoadAnimName` text,
  `PrecastHoldAnimName` text,
  PRIMARY KEY (`ID`)
...
INSERT INTO `spellvisualprecasttransitions` VALUES (1,'LoadBow','HoldBow'),(2,'LoadRifle','HoldRifle'),(3,'LoadThrown','HoldThrown');
