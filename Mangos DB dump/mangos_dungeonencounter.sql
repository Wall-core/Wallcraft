...
--
-- Dumping data for table `dungeonencounter`
--

LOCK TABLES `dungeonencounter` WRITE;
/*!40000 ALTER TABLE `dungeonencounter` DISABLE KEYS */;
/*!40000 ALTER TABLE `dungeonencounter` ENABLE KEYS */;
UNLOCK TABLES;
